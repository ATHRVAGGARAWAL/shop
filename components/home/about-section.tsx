...
export function AboutSection() {
    ...
    return (
        <section ref={ref} className="relative min-h-screen bg-white py-32 px-6 md:px-12">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                >
                    <h2 className="text-5xl md:text-7xl font-display font-bold text-slate-900 mb-6">
                        Our Legacy
                    </h2>
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <div className="text-blue-600 text-sm font-bold tracking-widest mb-6 uppercase">SINCE 1995</div>
                        <h3 className="text-4xl font-display font-bold text-slate-900 mb-6 leading-tight">
                            A Family Business Built on Trust
                        </h3>
                        <p className="text-slate-600 leading-relaxed mb-6">
                            For over 28 years, DEVKI NANDAN & SONS has been the cornerstone of electrical
                    ...
                    >
                        ...
                        <div className="border-l-2 border-blue-600 pl-6">
                            <h4 className="text-xl font-display text-slate-900 mb-2">Experience</h4>
                            <p className="text-slate-500 text-sm">
                                Decades of expertise in electrical goods and deep industry knowledge
                            </p>
                        </div>
                        <div className="border-l-2 border-blue-600 pl-6">
                            <h4 className="text-xl font-display text-slate-900 mb-2">Consistency</h4>
                            <p className="text-slate-500 text-sm">
                                Reliable supply chain ensuring products are always available when you need them
                            </p>
                        </div>
                        <div className="border-l-2 border-blue-600 pl-6">
                            <h4 className="text-xl font-display text-slate-900 mb-2">Trust</h4>
                            <p className="text-slate-500 text-sm">
